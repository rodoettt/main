...
void ImportWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->dataProcessed((*reinterpret_cast<std::add_pointer_t<QStringList>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ImportWindow::*)(const QStringList & )>(_a, &ImportWindow::dataProcessed, 0))
            return;
    }
}
...
// SIGNAL 0
void ImportWindow::dataProcessed(const QStringList & _t1)
{
